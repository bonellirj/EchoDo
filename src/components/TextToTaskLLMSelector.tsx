...
interface TextToTaskLLMSelectorProps {
  value: UserPreferences['textToTaskLLM'];
  onChange: (value: UserPreferences['textToTaskLLM']) => void;
}

const TextToTaskLLMSelector: React.FC<TextToTaskLLMSelectorProps> = ({ value, onChange }) => {
  const { t } = useTranslation();

  const handleLLMChange = (llm: string) => {
    onChange(llm as UserPreferences['textToTaskLLM']);
  };
...
export default TextToTaskLLMSelector; 